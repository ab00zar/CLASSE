  ...
  $(function() {
    ...
    function(start, end, label) {
      $("#daterange").on('apply.daterangepicker', function(){
        var tmp1 = start.format('YYYY-MM-DD') + "-" + end.format('YYYY-MM-DD');
        insertOneParam("daterange", tmp1);
      });
    });
  });
...
/////////////////   Search Filter - Source    ///////////////////////////////////   
      ...
      $("#local").on('change', function(){
          insertOneParam("source", "local");
        });

      $("#ais").on('change', function(){
          insertOneParam("source", "aishub");
        });
