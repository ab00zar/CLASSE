class ShipsController < ApplicationController
  ...
  private
    ...
    def ship_params
      params.require(:ship).permit(:_id, :name, :teu, :built, :deadweight, :draught, :length, :flag, :operator, :registered_owner, :shipmanager, :operator_url, :operator_list_url, :owner_url, :owner_list_url, :shipmanager_url, :shipmanager_list_url, :category)
    end
end
